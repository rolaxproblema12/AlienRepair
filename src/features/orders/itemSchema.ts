...
export const itemOrderSchema = z
  .object({
    ...
    item_description: z.string().trim().min(3, 'Describe el artículo'),
    device_type: z
      .enum(['celular', 'tablet', 'computadora', 'bocina', 'tv', 'consola', 'otro'])
      .optional()
      .nullable(),
...
export type ItemOrderInput = z.infer<typeof itemOrderSchema>;
